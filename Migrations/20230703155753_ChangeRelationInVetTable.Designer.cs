...
namespace VeterinarySystem.Migrations
{
    ...
    [Migration("20230703155753_ChangeRelationInVetTable")]
    partial class ChangeRelationInVetTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeterinarySystem.Models.Db.Vet", b =>
                {
                    b.HasOne("VeterinarySystem.Models.Db.Account", null)
                        .WithMany("Vets")
                        .HasForeignKey("AccountId");

                    b.HasOne("VeterinarySystem.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Vet")
                        .HasForeignKey("VeterinarySystem.Models.Db.Vet", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
